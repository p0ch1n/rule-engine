...
class Object:
    ...
    def with_offset(
        ...
        """Return a new Object with additive offsets applied."""
        return Object(
            x=self.x + dx,
            y=self.y + dy,
            w=max(0.0, self.w + dw),
    ...
    def with_scale(
        ...
        """Return a new Object with multiplicative scale applied to each dimension.
    ...
    def with_metadata(self, **kwargs: Any) -> "Object":
        """Return a new Object with additional metadata merged in."""
        return Object(
            x=self.x,
            y=self.y,
            w=self.w,
    ...
    def with_class(self, class_name: str) -> "Object":
        """Return a new Object with a different class label."""
        return Object(
            x=self.x,
            y=self.y,
            w=self.w,
    ...
    def union_obj(self, other: "Object") -> "Object":
    ...
    def __repr__(self) -> str:
        return (
            f"Object(cls={self.class_name!r}, "
