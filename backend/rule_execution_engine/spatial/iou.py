...
def _to_arrays(boxes: List[Object]) -> np.ndarray:
    """Convert list of Object to NumPy array of shape (N, 4) in xyxy format."""
    if not boxes:
...
def iou_matrix(boxes_a: List[Object], boxes_b: List[Object]) -> np.ndarray:
